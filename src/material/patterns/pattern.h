...
public:
    Pattern(const image::Color &color_a = image::Color{0, 0, 0}, const image::Color &color_b = image::Color{1, 1, 1}, const math::Matrix4d &transformation = math::identity<double, 4>(), double ambient = 0.1, double diffuse = 0.9, double specular = 0.9, double shininess = 200, double reflective = 0.0, double transparency = 0.0, double IOR = 1.0);
