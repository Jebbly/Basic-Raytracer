...
Triangle::Triangle(const math::Tuple4d &point1, const math::Tuple4d &point2, const math::Tuple4d &point3) :
    Primitive{},
...
// accessor methods
const math::Tuple4d& Triangle::get_point(int index) const
{
    assert(index < 3 && "index out of bounds");
    return m_points[index];
}

const math::Tuple4d& Triangle::get_edge(int index) const
{
...
math::Tuple4d Triangle::local_normal(const math::Tuple4d &t, const Intersection &hit) const
{
    return m_normal;
}
