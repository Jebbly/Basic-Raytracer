...
std::vector<Intersection> geometry::primitive::Sphere::local_intersect(const Ray &r) const
{
...
math::Tuple4d geometry::primitive::Sphere::local_normal(const math::Tuple4d &t, const Intersection &hit) const
{
    return (t - math::point<double>(0, 0, 0));
}

// utility functions
BoundingBox geometry::primitive::Sphere::local_bounds() const
{
