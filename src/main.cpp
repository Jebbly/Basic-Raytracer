...
int main()
{
    ...
    Cylinder left{math::identity<double, 4>().scale(0.33, 0.33, 0.33).translate(-1.5, 0.33, -1.5).rotate_y(constants::PI / 4), /*Material{math::color<double>(1, 0.8, 0.1), 0.1, 0.7, 1, 64}*/ std::make_shared<material::pattern::StripeMaterial>(stripes), 0, 1, true};
    Group g{};
