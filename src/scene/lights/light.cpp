...
{
    math::Tuple4d light_direction = direction(position);
	...
	std::shared_ptr<material::Material> mat = object->material;

	image::Color diffuse = effective_color * mat->diffuse * light_dot_normal;
	...
	{
	    image::Color specular = m_intensity * mat->specular * pow(reflect_dot_eye, mat->shininess);
